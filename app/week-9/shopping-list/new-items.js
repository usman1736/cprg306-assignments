...
export default function NewItems({ onAddItem }) {
  ...
  return (
    <div>
      <section className="md:ml-1 mb-5">
        <div className="md:ml-1 ml-10 border-1 border-black bg-white text-gray-600 pt-6 pb-4 pl-4 mt-4 rounded-sm w-100 h-108 pr-5">
